...
function Passwordgen() {
  ...
  return (
    <>
      <h1 className='text-6xl font-serif text-center text-white mb-36 mt-16'>Password Generator</h1>
      <div className='bg-fuchsia-900 text-white font-medium font-mono rounded-lg
       shadow shadow-yellow-50 overflow-hidden flex flex-col flex-wrap w-full px-2 py-2'>
        ...
        <div className='flex gap-2'>
          <input type="text"
            ...
            readOnly
            ref={PasswordRef} />
          <button onClick={copyPasswordToClipboard} className='bg-red-500 outline-none 
          rounded-lg p-2 text-white font-medium font-serif hover:scale-110 border-4'>Copy</button>
        </div>
